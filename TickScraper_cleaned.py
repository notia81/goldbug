...
focal = allData[(allData.day==26)&(allData.MOD<630)]
fix = '10:00:00'
...
fig=plt.figure()
plt.plot(allData[(allData.day==26)&(allData.MOD<630)].bid_v)
plt.plot(allData[(allData.day==26)&(allData.MOD<630)].ask_v)
plt.axvline(x=fix,color='r')
plt.legend(['Bid','Ask'])
